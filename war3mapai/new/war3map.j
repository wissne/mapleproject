...
function AV takes player p returns integer
return GetPlayerState(p,PLAYER_STATE_RESOURCE_GOLD)
endfunction
function NV takes player bV,integer BV returns nothing
call SetPlayerState(bV,PLAYER_STATE_RESOURCE_GOLD,AV(bV)+BV)
endfunction
...
if AV(GetOwningPlayer(GetSoldUnit()))>20*GetHeroLevel(la[vE])then
if vE<6 then
call ReviveHeroLoc(la[vE],GetRandomLocInRect(Yv),true)
else
call ReviveHeroLoc(la[vE],GetRandomLocInRect(ae),true)
endif
call cV(GetOwningPlayer(GetSoldUnit()),AV(GetOwningPlayer(GetSoldUnit()))-20*GetHeroLevel(la[vE]))
else
call Qn("复活英雄所需金子不够！")
endif
call RemoveUnit(GetSoldUnit())
...
if AV(GetTriggerPlayer())>20*GetHeroLevel(la[vE])then
if vE<6 then
call ReviveHeroLoc(la[vE],GetRandomLocInRect(Yv),true)
else
call ReviveHeroLoc(la[vE],GetRandomLocInRect(ae),true)
endif
call cV(GetTriggerPlayer(),AV(GetTriggerPlayer())-20*GetHeroLevel(la[vE]))
else
...
call SetUnitAbilityLevelSwapped('SCae',Ri,10)
call SetUnitAbilityLevelSwapped('SCae',Oi,10)
set ov[1]='E000'
set ov[2]='E003'
set ov[3]='O003'
set ov[4]='O002'
...
call SetUnitAbilityLevelSwapped('SCae',Ri,Kv[1])
call SetUnitAbilityLevelSwapped('SCae',Oi,Kv[2])
endfunction
...
function uO takes player UO,unit wO returns nothing
local string WO=""
...
call CreateNUnitsAtLoc(1,'h018',Player(0),GetRectCenter(yv),bj_UNIT_FACING)
endfunction
...
call StartTimerBJ(o[(1+GetPlayerId(GetOwningPlayer(GetTriggerUnit())))],false,(I2R(GetUnitLevel(GetTriggerUnit()))*5.))
call wa((I2R(GetUnitLevel(GetTriggerUnit()))*5.))
if(Vf())then
...
set yv=Rect(-5120.,-5984.,-4448.,-5344.)
...
set ie=Rect(3328.,3840.,4032.,4480.)
...
set p=Player(0)
set Ri=CreateUnit(p,'hcas',-5760.,-6976.,270.)
set ka=CreateUnit(p,'n002',-6976.,-7872.,270.)
set Ii=CreateUnit(p,'hbar',-4928.,-5888.,270.)
...
set p=Player(6)
set Oi=CreateUnit(p,'hcas',5120.,5504.,270.)
...
set fi=CreateUnit(p,'hbar',3840.,4480.,270.)
...
set Ue=CreateTrigger()
call TriggerRegisterUnitEvent(Ue,Oi,EVENT_UNIT_DEATH)
call TriggerAddAction(Ue,function fO)
set We=CreateTrigger()
call TriggerRegisterUnitEvent(We,Ri,EVENT_UNIT_DEATH)
...
set Ir=CreateTrigger()
call TriggerRegisterTimerEventPeriodic(Ir,12.)
call TriggerAddAction(Ir,function PC)
set Ar=CreateTrigger()
call TriggerRegisterTimerEventPeriodic(Ar,12.)
call TriggerAddAction(Ar,function uC)
set Nr=CreateTrigger()
call TriggerRegisterAnyUnitEventBJ(Nr,EVENT_PLAYER_UNIT_DEATH)
call TriggerAddAction(Nr,function WC)
set br=CreateTrigger()
call TriggerRegisterEnterRectSimple(br,yv)
...
call TriggerRegisterEnterRectSimple(hr,ie)
