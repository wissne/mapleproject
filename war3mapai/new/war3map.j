...
function Trig_Hero_Revive_Actions takes nothing returns nothing
    call StartTimerBJ(udg_Timer_ReviveHero[(1+GetPlayerId(GetOwningPlayer(GetTriggerUnit())))],false,(I2R(GetUnitLevel(GetTriggerUnit()))*0.00+3))//重生时间由5改为3秒
    call PolledWait((I2R(GetUnitLevel(GetTriggerUnit()))*0.00+3))	
