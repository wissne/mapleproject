...
//   Date: Sun Aug 09 20:49:39 2009
//   Map Author: Lovemoon03
//
//===========================================================================
...
globals
    ...
    unit                    udg_unit_hcas_0096         = null
    unit                    udg_unit_hcas_0137         = null
    unit                    udg_unit_harm_0111         = null
    unit                    udg_unit_harm_0128         = null
    unit                    udg_unit_harm_0144         = null
    unit                    udg_unit_harm_0145         = null
    unit                    udg_unit_hbla_0136         = null
    unit                    udg_unit_hbla_0175         = null
    unit                    udg_unit_h00P_0038         = null
    unit                    udg_unit_h00P_0039         = null
    unit                    udg_unit_h00P_0079         = null
    unit                    udg_unit_h00P_0080         = null
    unit                    udg_unit_n001_0198         = null
    unit                    udg_unit_n000_0199         = null
    unit                    udg_unit_n00Z_0200         = null
    unit                    udg_unit_n00B_0201         = null
    unit                    udg_unit_n01B_0203         = null
    unit                    udg_unit_n00Y_0205         = null
    unit                    udg_unit_hbar_0099         = null
    unit                    udg_unit_hbar_0098         = null
    unit                    udg_unit_hbar_0100         = null
    unit                    udg_unit_hbar_0151         = null
    unit                    udg_unit_hbar_0152         = null
    unit                    udg_unit_hbar_0153         = null
    unit                    udg_unit_h000_0041         = null
    unit                    udg_unit_h000_0042         = null
    unit                    udg_unit_h000_0044         = null
    unit                    udg_unit_h000_0045         = null
    unit                    udg_unit_h000_0047         = null
    unit                    udg_unit_h000_0048         = null
    unit                    udg_unit_h000_0050         = null
    unit                    udg_unit_h000_0051         = null
    unit                    udg_unit_h000_0053         = null
    unit                    udg_unit_h000_0054         = null
    unit                    udg_unit_h000_0082         = null
    unit                    udg_unit_h000_0083         = null
    unit                    udg_unit_h000_0085         = null
    unit                    udg_unit_h000_0086         = null
    unit                    udg_unit_h000_0088         = null
    unit                    udg_unit_h000_0089         = null
    unit                    udg_unit_h000_0090         = null
    unit                    udg_unit_h000_0092         = null
    unit                    udg_unit_h000_0094         = null
    unit                    udg_unit_h000_0095         = null
    unit                    udg_unit_hars_0113         = null
    unit                    udg_unit_hars_0147         = null
    ...
    trigger                 gg_trg_WEI_Left_Redoubt_2  = null
    trigger                 gg_trg_WEI_Left_Redoubt    = null
    trigger                 gg_trg_WEI_Right_Redoubt   = null
...
function getCurMaySlashUnit takes nothing returns nothing
    ...
    loop
        exitwhen (i == 20)
        set whichHero = zs_maple_MaySlash_Unit_Caster_Array[i]
...
function setCurMaySlashUnit takes unit whichHero returns nothing
    local integer index = zs_maple_MaySlash_Index
    set index = index + 1
    if index >= 20 then
        set index = 0
    endif
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set gg_unit_hbar_0099 = CreateUnit( p, 'hbar', -3648.0, -6976.0, 270.000 )
    set gg_unit_hbar_0100 = CreateUnit( p, 'hbar', -6848.0, -4672.0, 270.000 )
...
function CreateBuildingsForPlayer6 takes nothing returns nothing
    ...
    set gg_unit_hbar_0151 = CreateUnit( p, 'hbar', 3584.0, 5888.0, 270.000 )
    set gg_unit_hbar_0152 = CreateUnit( p, 'hbar', 3840.0, 4480.0, 270.000 )
    set gg_unit_hbar_0153 = CreateUnit( p, 'hbar', 5504.0, 3904.0, 270.000 )
...
function Trig_Morale_System_Actions takes nothing returns nothing
    ...
    call SetUnitAbilityLevelSwapped('SCae',gg_unit_hcas_0096,udg_Morale[1])
    call SetUnitAbilityLevelSwapped('SCae',gg_unit_hcas_0137,udg_Morale[2])
endfunction

//===========================================================================
function InitTrig_Morale_System takes nothing returns nothing
...
function Trig_Quest_Actions takes nothing returns nothing
    ...
    call QuestMessageBJ(bj_FORCE_ALL_PLAYERS,6,"|c00ff0000真|r|c00ff0913．|r|c00ff1327三|r|c00ff1d3a國|r|c00ff274e無|r|c00ff3162雙|r|c00ff3b75V|r|c00ff44893|r|c00ff4e9c.|r|c00ff58b09d|r
    ...
    |c0000ffffhttp://war3.custom.idv.tw/|r")
    ...
    call CreateQuestBJ(0,"AI","AI Made by wonder|n|nMap deprotected by MonKing|n|n感谢 ROUSTAR31 取得关键突破","ReplaceableTextures\\CommandButtons\\BTNAmbush.blp")
...
function InitTrig_SU_Win takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(gg_trg_SU_Win,gg_unit_hcas_0137,EVENT_UNIT_DEATH)
...
function InitTrig_WEI_Win takes nothing returns nothing
    ...
    call TriggerRegisterUnitEvent(gg_trg_WEI_Win,gg_unit_hcas_0096,EVENT_UNIT_DEATH)
...
function Trig_Hero_Selection_Actions takes nothing returns nothing
    if (Trig_Hero_Selection_Func001C()) then
        ...
        if (Trig_Hero_Selection_Func001Func003C()) then
            set udg_Temp_Point=GetRectCenter(gg_rct_SHU_HeroRevive)
        else
            set udg_Temp_Point=GetRectCenter(gg_rct_WEI_HeroRevive)
        endif
...
// Trigger: SU Move Hero
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_SU_Move_Hero_Actions takes nothing returns nothing
    set udg_Temp_Hero_Move=GetRectCenter(gg_rct_SHU_HeroRevive)
    call SetUnitPositionLoc(GetTriggerUnit(),udg_Temp_Hero_Move)
    call RemoveLocation(udg_Temp_Hero_Move)
endfunction

//===========================================================================
function InitTrig_SU_Move_Hero takes nothing returns nothing
    set gg_trg_SU_Move_Hero=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Move_Hero,gg_rct_SHU_TavernsRect)
    call TriggerAddAction(gg_trg_SU_Move_Hero,function Trig_SU_Move_Hero_Actions)
endfunction//===========================================================================
// Trigger: WEI Move Hero
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_WEI_Move_Hero_Actions takes nothing returns nothing
    set udg_Temp_Hero_Move=GetRectCenter(gg_rct_WEI_HeroRevive)
    call SetUnitPositionLoc(GetTriggerUnit(),udg_Temp_Hero_Move)
    call RemoveLocation(udg_Temp_Hero_Move)
endfunction

//===========================================================================
function InitTrig_WEI_Move_Hero takes nothing returns nothing
    set gg_trg_WEI_Move_Hero=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Move_Hero,gg_rct_WEI_TavernsRect)
...
//===========================================================================
function InitTrig_SU_Random_Hero takes nothing returns nothing
...
//===========================================================================
function InitTrig_WEI_Random_Hero takes nothing returns nothing
...
function Trig_Hero_Revive_Actions takes nothing returns nothing
    ...
    if (Trig_Hero_Revive_Func003C()) then
        call ReviveHeroLoc(GetTriggerUnit(),GetRandomLocInRect(gg_rct_SHU_HeroRevive),true)
    endif
    if (Trig_Hero_Revive_Func004C()) then
        call ReviveHeroLoc(GetTriggerUnit(),GetRandomLocInRect(gg_rct_WEI_HeroRevive),true)
    endif
...
function Trig_May_Slash_2_Actions takes nothing returns nothing
	...
	call setCurMaySlashUnit(udg_MaySlash_Unit_Caster)
...
// Trigger: To die together and Arrow Skill
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
// Trigger: Get Kill Slash for Hero
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
// Trigger: Dark Domain Unit Remove
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Left_Barrack_Actions takes nothing returns nothing
    if (Trig_SU_Left_Barrack_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_RedoubtLeft2)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_SU_Left_Barrack takes nothing returns nothing
    set gg_trg_SU_Left_Barrack=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Left_Barrack,gg_rct_SHU_BarrackLeft)
    call TriggerAddAction(gg_trg_SU_Left_Barrack,function Trig_SU_Left_Barrack_Actions)
endfunction//===========================================================================
// Trigger: SU Right Barrack
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Right_Barrack_Actions takes nothing returns nothing
    if (Trig_SU_Right_Barrack_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WU_Help)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_SU_Right_Barrack takes nothing returns nothing
    set gg_trg_SU_Right_Barrack=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Right_Barrack,gg_rct_SHU_BarrackRight)
    call TriggerAddAction(gg_trg_SU_Right_Barrack,function Trig_SU_Right_Barrack_Actions)
endfunction//===========================================================================
// Trigger: SU Right Redoubt
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
//===========================================================================
function InitTrig_SU_Right_Redoubt takes nothing returns nothing
    set gg_trg_SU_Right_Redoubt=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Right_Redoubt,gg_rct_SHU_RedoubtRight)
    call TriggerAddAction(gg_trg_SU_Right_Redoubt,function Trig_SU_Right_Redoubt_Actions)
endfunction//===========================================================================
// Trigger: SU Left Redoubt
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Left_Redoubt_Actions takes nothing returns nothing
    ...
    if (Trig_SU_Left_Redoubt_Func002C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_Door)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
endfunction
...
//===========================================================================
function InitTrig_SU_Left_Redoubt takes nothing returns nothing
    set gg_trg_SU_Left_Redoubt=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Left_Redoubt,gg_rct_SHU_RedoubtLeft)
    call TriggerAddAction(gg_trg_SU_Left_Redoubt,function Trig_SU_Left_Redoubt_Actions)
endfunction//===========================================================================
// Trigger: SU Left Redoubt 2
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Left_Redoubt_2_Actions takes nothing returns nothing
    ...
    if (Trig_SU_Left_Redoubt_2_Func002C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_SHU_BarrackLeft)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
endfunction
...
//===========================================================================
function InitTrig_SU_Left_Redoubt_2 takes nothing returns nothing
    set gg_trg_SU_Left_Redoubt_2=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Left_Redoubt_2,gg_rct_Door)
    call TriggerAddAction(gg_trg_SU_Left_Redoubt_2,function Trig_SU_Left_Redoubt_2_Actions)
endfunction//===========================================================================
// Trigger: SU Right Redoubt 2
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Right_Redoubt_2_Actions takes nothing returns nothing
    if (Trig_SU_Right_Redoubt_2_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_RedoubtRight)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_SU_Right_Redoubt_2 takes nothing returns nothing
    set gg_trg_SU_Right_Redoubt_2=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_SU_Right_Redoubt_2,gg_rct_WU_Help)
    call TriggerAddAction(gg_trg_SU_Right_Redoubt_2,function Trig_SU_Right_Redoubt_2_Actions)
endfunction//===========================================================================
// Trigger: WEI Left Redoubt 2
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_WEI_Left_Redoubt_2_Func001C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==PLAYER_COLOR_RED))
endfunction
function Trig_WEI_Left_Redoubt_2_Func002C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==GetPlayerColor(Player(6))))
endfunction
function Trig_WEI_Left_Redoubt_2_Actions takes nothing returns nothing
    if (Trig_WEI_Left_Redoubt_2_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_Base)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
    if (Trig_WEI_Left_Redoubt_2_Func002C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_Door)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_WEI_Left_Redoubt_2 takes nothing returns nothing
    set gg_trg_WEI_Left_Redoubt_2=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Left_Redoubt_2,gg_rct_WEI_RedoubtLeft2)
    call TriggerAddAction(gg_trg_WEI_Left_Redoubt_2,function Trig_WEI_Left_Redoubt_2_Actions)
endfunction//===========================================================================
// Trigger: WEI Left Redoubt
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_WEI_Left_Redoubt_Func001C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==PLAYER_COLOR_RED))
endfunction
function Trig_WEI_Left_Redoubt_Func002C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==GetPlayerColor(Player(6))))
endfunction
function Trig_WEI_Left_Redoubt_Actions takes nothing returns nothing
    if (Trig_WEI_Left_Redoubt_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_Base)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
    if (Trig_WEI_Left_Redoubt_Func002C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_RedoubtLeft2)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_WEI_Left_Redoubt takes nothing returns nothing
    set gg_trg_WEI_Left_Redoubt=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Left_Redoubt,gg_rct_WEI_RedoubtLeft)
    call TriggerAddAction(gg_trg_WEI_Left_Redoubt,function Trig_WEI_Left_Redoubt_Actions)
endfunction//===========================================================================
// Trigger: WEI Right Redoubt
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_WEI_Right_Redoubt_Func001C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==PLAYER_COLOR_RED))
endfunction
function Trig_WEI_Right_Redoubt_Func002C takes nothing returns boolean
    return ((GetPlayerColor(GetOwningPlayer(GetEnteringUnit()))==GetPlayerColor(Player(6))))
endfunction
function Trig_WEI_Right_Redoubt_Actions takes nothing returns nothing
    if (Trig_WEI_Right_Redoubt_Func001C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_Base)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
    if (Trig_WEI_Right_Redoubt_Func002C()) then
        set udg_TempMovementPoint=GetRectCenter(gg_rct_WU_Help)
        call IssuePointOrderByIdLoc(GetEnteringUnit(),851983,udg_TempMovementPoint)
        call RemoveLocation(udg_TempMovementPoint)
    endif
...
//===========================================================================
function InitTrig_WEI_Right_Redoubt takes nothing returns nothing
    set gg_trg_WEI_Right_Redoubt=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Right_Redoubt,gg_rct_WEI_RedoubtRight)
    call TriggerAddAction(gg_trg_WEI_Right_Redoubt,function Trig_WEI_Right_Redoubt_Actions)
endfunction//===========================================================================
// Trigger: WEI Center Barrack
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
//===========================================================================
function InitTrig_WEI_Left_Barrack takes nothing returns nothing
    set gg_trg_WEI_Left_Barrack=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Left_Barrack,gg_rct_WEI_BarrackLeft)
...
//===========================================================================
function InitTrig_WEI_Right_Barrack takes nothing returns nothing
    set gg_trg_WEI_Right_Barrack=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_WEI_Right_Barrack,gg_rct_WEI_BarrackRight)
...
//===========================================================================
function InitTrig_SU_Right_Create takes nothing returns nothing
...
//===========================================================================
function InitTrig_SU_Left_Create takes nothing returns nothing
...
//===========================================================================
function InitTrig_WEI_Right_Create takes nothing returns nothing
...
//===========================================================================
function InitTrig_WEI_Left_Create takes nothing returns nothing
...
//===========================================================================
function InitTrig_WEI_Right_Kingh takes nothing returns nothing
...
//===========================================================================
function InitTrig_WEI_Left_Kingh takes nothing returns nothing
...
// Trigger: SU Right Kingh
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_SU_Right_Kingh_Conditions takes nothing returns boolean
    return ((IsUnitDeadBJ(gg_unit_hbar_0099)))
endfunction
function Trig_SU_Right_Kingh_Actions takes nothing returns nothing
    call CreateNUnitsAtLoc(1,'h018',Player(0),GetRectCenter(gg_rct_SHU_BarrackRight),bj_UNIT_FACING)
endfunction

//===========================================================================
function InitTrig_SU_Right_Kingh takes nothing returns nothing
...
//===========================================================================
// Trigger: SU Left Kingh
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
function Trig_SU_Left_Kingh_Conditions takes nothing returns boolean
    return ((IsUnitDeadBJ(gg_unit_hbar_0100)))
endfunction
function Trig_SU_Left_Kingh_Actions takes nothing returns nothing
    call CreateNUnitsAtLoc(1,'h018',Player(0),GetRectCenter(gg_rct_SHU_BarrackLeft),bj_UNIT_FACING)
endfunction

//===========================================================================
function InitTrig_SU_Left_Kingh takes nothing returns nothing
...
//===========================================================================
function InitTrig_Call_The_Auxiliaries takes nothing returns nothing
...
function Trig_Xiongnu_Auxiliarie_Actions takes nothing returns nothing
    call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|CFF66FF00匈奴出現在北方，似乎跟曹操串通，
    開始攻擊蜀國了！|R")
    set udg_TempMovementPoint=GetRectCenter(gg_rct_WEI_RedoubtLeft2)
...
//===========================================================================
function InitTrig_Xiongnu_Auxiliarie takes nothing returns nothing
...
function Trig_Wu_Auxiliaries_Actions takes nothing returns nothing
    call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|CFF66FF00吳軍出現在南方，似乎跟劉備串通，
    開始攻擊魏國了！|R")
    call CreateNUnitsAtLoc(1,'h00Q',Player(0),GetRectCenter(gg_rct_WU_Help),bj_UNIT_FACING)
    call UnitApplyTimedLifeBJ(120.00,'BTLF',bj_lastCreatedUnit)
    call CreateNUnitsAtLoc(1,'h00R',Player(0),GetRectCenter(gg_rct_WU_Help),bj_UNIT_FACING)
    call UnitApplyTimedLifeBJ(120.00,'BTLF',bj_lastCreatedUnit)
    call CreateNUnitsAtLoc(3,'h00P',Player(0),GetRectCenter(gg_rct_WU_Help),bj_UNIT_FACING)
    call CreateNUnitsAtLoc(5,'hfoo',Player(0),GetRectCenter(gg_rct_WU_Help),bj_UNIT_FACING)
    call TriggerSleepAction(120.00)
    call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|CFF66FF00吳軍似乎撤退了.|R")
endfunction

//===========================================================================
function InitTrig_Wu_Auxiliaries takes nothing returns nothing
...
//===========================================================================
function InitTrig_Wu_move takes nothing returns nothing
    set gg_trg_Wu_move=CreateTrigger()
    call TriggerRegisterEnterRectSimple(gg_trg_Wu_move,gg_rct_WU_Help)
    call TriggerRegisterEnterRectSimple(gg_trg_Wu_move,gg_rct_WEI_RedoubtRight)
    call TriggerRegisterEnterRectSimple(gg_trg_Wu_move,gg_rct_WEI_BarrackRight)
...
function Trig_Create_item_Actions takes nothing returns nothing
    if (Trig_Create_item_Func001C()) then
        call CreateItemLoc(ChooseRandomItemExBJ(1,ITEM_TYPE_ARTIFACT),GetRectCenter(gg_rct_LeftBarrel))
        call PolledWait(160.00)
        call CreateNUnitsAtLoc(1,'hwtw',Player(12),GetRectCenter(gg_rct_LeftBarrel),bj_UNIT_FACING)
    endif
    if (Trig_Create_item_Func002C()) then
        call CreateItemLoc(ChooseRandomItemExBJ(1,ITEM_TYPE_ARTIFACT),GetRectCenter(gg_rct_RightBarrel))
        call PolledWait(160.00)
        call CreateNUnitsAtLoc(1,'hgtw',Player(12),GetRectCenter(gg_rct_RightBarrel),bj_UNIT_FACING)
    endif
endfunction
...
// Trigger: Item Synthesization 2
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
//I01D:妖刀村正=铁树枝干+铁树枝干+净化药水+武士刀+青虹剑+I022
//I01R:铁树枝干
//pclr:净化药水
//I022:此物品没有
//I027:武士刀
...
// Trigger: Double Item Synthesization
//===========================================================================
//TESH.scrollpos=2
//TESH.alwaysfold=0
...
// Trigger: Double Item Synthesization 2
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
// Trigger: Double Item Synthesization 3
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
// Trigger: Double Item Synthesization 4
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
// Trigger: Double Item Synthesization 5
//===========================================================================
//TESH.scrollpos=0
//TESH.alwaysfold=0
...
function Trig_SU_Barn_Die_Actions takes nothing returns nothing
    ...
    call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"蜀國穀倉被破壞了!\n所有魏國武將獲得800兩")
...
function Trig_WEI_Barn_Die_Actions takes nothing returns nothing
    ...
    call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"魏國穀倉被破壞了!\n所有蜀國武將獲得800兩")
    call TriggerSleepAction(6.00)
...
function InitCustomTriggers takes nothing returns nothing
    ...
    call InitTrig_SU_Move_Hero(  )
    call InitTrig_WEI_Move_Hero(  )
    call InitTrig_Remove_Player(  )
    call InitTrig_Move_Hero(  )
    call InitTrig_WU_Move_Hero(  )
    call InitTrig_Remove_WU(  )
    call InitTrig_SU_Random_Hero(  )
    call InitTrig_WEI_Random_Hero(  )
    call InitTrig_Allrandom(  )
    ...
    call InitTrig_SU_Left_Barrack(  )
    call InitTrig_SU_Right_Barrack(  )
    call InitTrig_SU_Right_Redoubt(  )
    call InitTrig_SU_Left_Redoubt(  )
    call InitTrig_SU_Left_Redoubt_2(  )
    call InitTrig_SU_Right_Redoubt_2(  )
    call InitTrig_WEI_Left_Redoubt_2(  )
    call InitTrig_WEI_Left_Redoubt(  )
    call InitTrig_WEI_Right_Redoubt(  )
    call InitTrig_WEI_Center_Barrack(  )
    call InitTrig_WEI_Left_Barrack(  )
    call InitTrig_WEI_Right_Barrack(  )
    call InitTrig_Create_On(  )
    call InitTrig_AddFootman(  )
    call InitTrig_AddArcher(  )
    call InitTrig_SU_Right_Create(  )
    call InitTrig_SU_Center_Create(  )
    call InitTrig_SU_Left_Create(  )
    call InitTrig_WEI_Right_Create(  )
    call InitTrig_WEI_Center_Create(  )
    call InitTrig_WEI_Left_Create(  )
    call InitTrig_WEI_Right_Kingh(  )
    call InitTrig_WEI_Center_Kingh(  )
    call InitTrig_WEI_Left_Kingh(  )
    call InitTrig_SU_Right_Kingh(  )
    call InitTrig_SU_Center_Kingh(  )
    call InitTrig_SU_Left_Kingh(  )
    call InitTrig_SU_and_WEI(  )
    call InitTrig_Call_The_Auxiliaries(  )
    call InitTrig_Xiongnu_Auxiliarie(  )
    call InitTrig_Wu_Auxiliaries(  )
    call InitTrig_Wu_move(  )
    call InitTrig_Create_item(  )
